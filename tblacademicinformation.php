...
if (isset($_POST['insert'])) {
    ...
    $FromHighSchoolID = $_POST['FromHighSchoolID'];
    $NationalExamYear = $_POST['NationalExamYear'];

    $sql = "INSERT INTO `tblacademicinformation` (`StudentID`,`FromHighSchoolID`,`NationalExamYear`) VALUES ('$StudentID','$FromHighSchoolID','$NationalExamYear') ";
...
if (isset($_POST['search'])){
    $AcademicInformationID = $_POST['AcademicInformationID'];
    $sql = "SELECT * from tblacademicinformation Where AcademicInformationID=$AcademicInformationID ";

    $query = mysqli_query($conn, $sql);
    while ($data = mysqli_fetch_array($query)) {
        header("location:tblsex.php?AcademicInformationID=" . $data['AcademicInformationID'] . "&StudentID=" . $data['StudentID']. "&FromHighSchoolID=" . $data['FromHighSchoolID']. "&NationalExamYear=" . $data['NationalExamYear']);
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="navigation">
        ...
        <div class="main">
            ...
            <form action="tblacademicinformation.php" method="POST" class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2" for="sex_id">
                     AcademicInformation ID
                    </label>
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sex_id" name="AcademicInformationID" type="text" placeholder="Enter AcademicInformation ID" value="<?php if (!empty($_GET)) echo $_GET['AcademicInformationID'] ?>">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sex_name" name="FromHighSchoolID" type="text" placeholder="Enter From HighSchool ID" value="<?php if (!empty($_GET)) echo $_GET['FromHighSchoolID'] ?>">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2" for="sex_name">
                    National Exam Year
                    </label>
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sex_name" name="NationalExamYear" type="text" placeholder="Enter National Exam Year" value="<?php if (!empty($_GET)) echo $_GET['NationalExamYear'] ?>">
                </div>
