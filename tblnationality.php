...
if (isset($_POST['insert'])) {
    ...
    $sql = "INSERT INTO `tblnationality` (`NationalityName`) VALUES ('$NationalityName') ";
...
if (isset($_POST['search'])){
    ...
    $sql = "SELECT * from tblsex Where NationalityID=$NationalityID ";

    $query = mysqli_query($conn, $sql);
    while ($data = mysqli_fetch_array($query)) {
        header("location:tblsex.php?NationalityID=" . $data['NationalityID'] . "&NationalityName=" . $data['NationalityName']);
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="navigation">
        ...
        <div class="main">
            ...
            <form action="nationality.php" method="POST" class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2" for="sex_id">
                    Nationality ID
                    </label>
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sex_id" name="NationalityID" type="text" placeholder="Enter Nationality ID" value="<?php if (!empty($_GET)) echo $_GET['NationalityID'] ?>">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2" for="sex_name">
                    Nationality Name
                    </label>
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sex_name" name="NationalityName" type="text" placeholder="Enter Nationality Name" value="<?php if (!empty($_GET)) echo $_GET['NationalityName'] ?>">
                </div>
