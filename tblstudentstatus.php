...
if (isset($_POST['insert'])) {
    ...
    $sql = "INSERT INTO `tbltransfer` (`StudentID`,`AcademicProgramID`) VALUES ('$StudentID','$AcademicProgramID') ";
...
if (isset($_POST['search'])){
    ...
    $sql = "SELECT * from tblstudentstatus Where StudentStatusID=$StudentStatusID ";

    $query = mysqli_query($conn, $sql);
    while ($data = mysqli_fetch_array($query)) {
        header("location:tbltransfer.php?StudentStatusID=" . $data['StudentStatusID'] . "&StudentID=" . $data['StudentID']. "&AcademicProgramID=" . $data['AcademicProgramID']);
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="navigation">
        ...
        <div class="main">
            ...
            <form action="tblstudentstatus.php" method="POST" class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2" for="sex_id">
                    Student Status ID
                    </label>
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sex_id" name="StudentStatusID" type="text" placeholder="Enter StudentStatus ID" value="<?php if (!empty($_GET)) echo $_GET['StudentStatusID'] ?>">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sex_id" name="AcademicProgramID" type="text" placeholder="Enter Academic Program ID" value="<?php if (!empty($_GET)) echo $_GET['AcademicProgramID'] ?>">
                </div>
