                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                    <a href="#" onclick="showSweetAlert('<?php echo $id; ?>', 
                                    // '<?php echo htmlspecialchars(addslashes($nameKh), ENT_QUOTES, 'UTF-8'); ?>',
                                    //  '<?php echo htmlspecialchars(addslashes($nameEn), ENT_QUOTES, 'UTF-8'); ?>',
                                    //   '<?php echo htmlspecialchars(addslashes($sex), ENT_QUOTES, 'UTF-8'); ?>',
                                    //    '<?php echo htmlspecialchars(addslashes($photo), ENT_QUOTES, 'UTF-8'); ?>', 
                                    //    '<?php echo htmlspecialchars(addslashes($Nationality), ENT_QUOTES, 'UTF-8'); ?>', 
                                    //    '<?php echo htmlspecialchars(addslashes($dob), ENT_QUOTES, 'UTF-8'); ?>',
                                    //     '<?php echo htmlspecialchars(addslashes($ProvinceOfBirthID), ENT_QUOTES, 'UTF-8'); ?>',
                                    //      '<?php echo htmlspecialchars(addslashes($DistrictOfBirthID), ENT_QUOTES, 'UTF-8'); ?>', 
                                    //      '<?php echo htmlspecialchars(addslashes($CommuneOfBirthID), ENT_QUOTES, 'UTF-8'); ?>', 
                                    //      '<?php echo htmlspecialchars(addslashes($VillageOfBirthID), ENT_QUOTES, 'UTF-8'); ?>',
                                    //       '<?php echo htmlspecialchars(addslashes($PhoneNumber1), ENT_QUOTES, 'UTF-8'); ?>',
                                    //        '<?php echo htmlspecialchars(addslashes($PhoneNumber2), ENT_QUOTES, 'UTF-8'); ?>',
                                    //        '<?php echo htmlspecialchars(addslashes($TelegramNumber), ENT_QUOTES, 'UTF-8'); ?>',
                                    //        '<?php echo htmlspecialchars(addslashes($Email), ENT_QUOTES, 'UTF-8'); ?>',
                                    //        '<?php echo htmlspecialchars(addslashes($FromHighSchool), ENT_QUOTES, 'UTF-8'); ?>',
                                           
                                           )"
                                            
                                           class="inline-flex items-center px-3 py-1.5 bg-indigo-600 text-white font-semibold text-xs rounded hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                        <span class="mr-2">
...
<script>
    ...
    function showSweetAlert(id, nameKh, nameEn, sex, photo, Nationality,  ProvinceOfBirthID, DistrictOfBirthID, CommuneOfBirthID, VillageOfBirthID,
    PhoneNumber1, PhoneNumber2,TelegramNumber,Email,FromHighSchool) {
        Swal.fire({
            ...
            html: '<div class="flex">' +
                ...
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Nationality ID: ' + Nationality + '</div>' +
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Register Date: ' + ProvinceOfBirthID + '</div>' +
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Date of Birth: ' + DistrictOfBirthID + '</div>' +
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Place of Birth: ' + CommuneOfBirthID + '</div>' +
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Phone 1: ' + VillageOfBirthID + '</div>' +
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Phone 2: ' + PhoneNumber1 + '</div>' +
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Telegram: ' + PhoneNumber2 + '</div>' +
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Email: ' + TelegramNumber + '</div>' +
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Email: ' + Email + '</div>' +
                '<div class="border border-black-300 p-4 hover:bg-red-500 transition-colors duration-300 hover:text-white">Email: ' + FromHighSchool + '</div>' +
                '</div>' +
                '</div>',
